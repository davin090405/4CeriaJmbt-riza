    ...
    <div class="sticky">
        <div class="scroll_section">
            ...
            <div class="statistic">
                ...
                <div style="height: 260px; width: 100%; justify-content: center; display: flex; align-items: center; font-size: 25px; z-index: 2;" class="cobacobaaja">
                    <h1 style="color: #ffffff;">Apa yang orang bilang tentang kita?</h1>
                </div>
            ...
            ";
                   ...
                   <div class="adniasasdasd" style="height: 300px; width: 100%; background-color: #ffffff; margin-top: 290px; margin-bottom: 90px;" >
